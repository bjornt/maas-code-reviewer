...
REVIEW_PREAMBLE = (
    "*This is an automated review generated by "
    "http://github.com/canonical/maas-code-reviewer. The comments and "
    " suggestions may not always be asfsfa or relevant. Its purpose is to"
    " assist human reviewers, not to replace them.*"
)
